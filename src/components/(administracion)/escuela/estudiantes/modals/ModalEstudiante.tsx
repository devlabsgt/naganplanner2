...
export default function ModalEstudiante({ isOpen, onClose, estudiante, readOnly = false, perfilActual }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-[5px] bg-black/80 backdrop-blur-[2px] animate-in fade-in duration-200">
            <div className="bg-white dark:bg-[#0f0f0f] w-full max-w-[500px] rounded-[2.5rem] shadow-2xl flex flex-col border border-[#d5cec2] dark:border-[#3e3630] animate-in zoom-in-95 duration-200 overflow-hidden text-[#4a3f36] dark:text-[#f4ebc3]">
                
                {/* HEADER */}
                <div className="px-3 py-5 border-b border-[#d5cec2] dark:border-[#3e3630] flex justify-between items-center bg-[#fafafa] dark:bg-[#0d0d0d]">
                ...
                <form id="estudiante-form" onSubmit={handleSubmit(onSubmit)} className="p-3 md:p-8 space-y-6 max-h-[70vh] overflow-y-auto no-scrollbar">
                    {/* Nombre */}
                    <div className="space-y-1.5 px-0.5">
                        ...
                        <input
                            ...
                            className={`w-full px-5 py-4 bg-[#f5f5f5] dark:bg-[#161616] border ${errors.nombre ? 'border-red-500' : 'border-[#e5e5e5] dark:border-[#2a2420]'} rounded-2xl outline-none focus:border-[#d6a738]/50 transition-colors text-[#4a3f36] dark:text-white font-bold text-sm disabled:opacity-60 placeholder:text-[#847563]/50`}
                        />
                    </div>
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${isSelected
                                                ...
                                                : 'bg-[#f5f5f5] dark:bg-[#161616] border-[#e5e5e5] dark:border-[#2a2420] text-[#847563]'}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 px-0.5">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                disabled={readOnly}
                                className="w-full px-5 py-4 bg-[#f5f5f5] dark:bg-[#161616] border border-[#e5e5e5] dark:border-[#2a2420] rounded-2xl outline-none text-[#4a3f36] dark:text-white font-bold text-sm disabled:opacity-60"
                            />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-[#847563] uppercase tracking-widest flex items-center gap-2 ml-1">
                ...
                {/* FOOTER */}
                {!readOnly && (
                    <div className="px-3 py-6 border-t border-[#d5cec2] dark:border-[#3e3630] flex flex-col items-center bg-[#fafafa] dark:bg-[#0d0d0d] gap-4">
                        <button
                            type="submit"
