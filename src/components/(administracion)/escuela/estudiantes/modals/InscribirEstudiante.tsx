...
export default function InscribirEstudiante({ isOpen, onClose, aulaId }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-[#0f0f0f] w-full max-w-[550px] rounded-3xl shadow-2xl flex flex-col max-h-[95vh] overflow-hidden border border-[#d5cec2] dark:border-[#3e3630] animate-in zoom-in-95 duration-200 shadow-gold/5">

                {/* HEADER */}
                <div className="px-6 py-5 border-b border-[#d5cec2] dark:border-[#3e3630] flex justify-between items-center bg-white dark:bg-[#0f0f0f] z-10">
                ...
                {/* BUSCADOR GENERAL */}
                <div className="p-6 border-b border-[#d5cec2] dark:border-[#3e3630] bg-[#fafafa] dark:bg-[#0f0f0f]">
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-white dark:bg-[#161616] border border-[#d5cec2] dark:border-[#3e3630] rounded-2xl outline-none focus:border-[#d6a738]/50 transition-colors text-[#4a3f36] dark:text-white font-bold text-sm placeholder:text-[#847563]/40"
                        />
                    </div>
                        ...
                        <div className="mt-4 space-y-2 max-h-[220px] overflow-y-auto custom-scrollbar animate-in slide-in-from-top-2 duration-200">
                            ...
                            {resultadosBusqueda.length > 0 ? (
                                resultadosBusqueda.map((est) => (
                                    <div 
                                        key={est.id}
                                        className="group bg-white dark:bg-[#161616] border border-[#d5cec2] dark:border-[#2a2420] hover:border-[#d6a738]/40 rounded-2xl p-4 flex items-center justify-between transition-all shadow-sm"
                                    >
                ...
                {/* FORMULARIO DE "NUEVO" */}
                <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar bg-[#0a0a0a]/50">
                    <div className="flex items-center gap-3 opacity-30">
                        <div className="flex-1 h-px bg-[#3e3630]"></div>
                    ...
                    >
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className={`w-full px-5 py-3.5 bg-white dark:bg-[#161616] border ${errors.nombre ? 'border-red-500' : 'border-[#d5cec2] dark:border-[#2a2420]'} rounded-2xl outline-none focus:border-[#d6a738]/50 transition-colors text-[#4a3f36] dark:text-white font-bold text-sm placeholder:text-[#847563]/40`}
                            />
                                        ...
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isSelected
                                                    ...
                                                    : 'bg-white dark:bg-[#161616] border-[#d5cec2] dark:border-[#2a2420] text-[#847563] hover:border-[#d6a738]/40 hover:text-[#4a3f36] dark:hover:text-[#f4ebc3]'}
                                            `}
                                        >
                                            {g.label}
                                        </button>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1 space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-3.5 bg-white dark:bg-[#161616] border border-[#d5cec2] dark:border-[#2a2420] rounded-2xl outline-none focus:border-[#d6a738]/50 transition-colors text-[#4a3f36] dark:text-white font-bold text-sm"
                                />
                            </div>
                            <div className="flex-1 space-y-1.5">
                                <label className="text-[10px] font-black text-[#847563] uppercase tracking-widest flex items-center gap-2 ml-1">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-3.5 bg-white dark:bg-[#161616] border border-[#d5cec2] dark:border-[#2a2420] rounded-2xl outline-none focus:border-[#d6a738]/50 transition-colors text-[#4a3f36] dark:text-white font-bold text-sm placeholder:text-[#847563]/40"
                                />
                            </div>
                        </div>
                    </form>
                ...
                {/* FOOTER */}
                <div className="px-6 py-5 border-t border-[#d5cec2] dark:border-[#3e3630] flex justify-center bg-white dark:bg-[#0f0f0f]">
                    <button
                        type="submit"
                        form="inscribir-form"
