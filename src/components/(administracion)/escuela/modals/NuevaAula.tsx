    ...
    return (
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                <div className="bg-white dark:bg-[#1a1a1a] w-full max-w-[600px] rounded-3xl shadow-2xl flex flex-col max-h-[95vh] overflow-hidden border border-gray-100 dark:border-neutral-800 animate-in zoom-in-95 duration-200">
                    ...
                    {/* CONTENIDO */}
                    <form id="aula-form" onSubmit={handleSubmit(onSubmit)} className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6 custom-scrollbar">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className={`font-black text-sm uppercase tracking-tight ${horarioSeleccionado ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                                        {horarioSeleccionado ? horarioSeleccionado.nombre : 'Seleccionar Horario Maestro'}
                                    </h4>
                    ...
                    {/* FOOTER */}
                    <div className="px-8 py-5 border-t border-gray-100 dark:border-neutral-800 bg-white dark:bg-[#1a1a1a] flex justify-end gap-3 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.05)]">
                        <button type="button" onClick={onClose} className="px-8 py-3 text-gray-600 dark:text-gray-300 font-black text-xs uppercase tracking-widest hover:bg-gray-50 dark:hover:bg-neutral-800 rounded-xl transition-all border border-transparent hover:border-gray-200 dark:hover:border-neutral-700">
                            Cancelar
                        </button>
                        <button type="submit" form="aula-form" disabled={guardar.isPending} className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-10 py-3 bg-[#d6a738] hover:bg-[#c08e2a] text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-xl shadow-[#d6a738]/30 disabled:opacity-70 transition-all transform active:scale-95">
